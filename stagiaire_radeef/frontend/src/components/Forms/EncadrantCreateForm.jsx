  ...
  const formSchema = z.object({
    ...
    departement :z.string().max(255)
  })
  export default function EncadrantCreateForm({handleSubmit,values}) {
    const form = useForm({
    ...
    const onSubmit = async values => {
      const loaderMsg = isUpdate? 'Mise à jour en cours.':'Ajout d encadrant'
